...
from src.prompt_builder import build_rag_prompt, build_baseline_prompt
...
rag_prompt = build_rag_prompt(query, retrieved_chunks, max_chunks=3, max_characters=2500)
